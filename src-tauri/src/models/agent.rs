...
impl AgentConfig {
    pub fn default_known() -> Vec<Self> {
        ...
        vec![
            ...
            AgentConfig {
                agent_type: KnownAgentType::Windsurf.into(),
                name: "windsurf".into(),
            ...
            AgentConfig {
                agent_type: KnownAgentType::Trae.into(),
                name: "trae".into(),
            ...
            AgentConfig {
                agent_type: KnownAgentType::Antigravity.into(),
                name: "antigravity".into(),
                display_name: "Antigravity".into(),
                skills_dir: ".gemini/antigravity/skills".into(),
                global_skills_dir: home.join(".gemini/antigravity/global_skills"),
                icon: "Zap".into(),
                installed: false,
                is_custom: false,
            },
